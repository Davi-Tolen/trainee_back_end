...
routes.get(
  ...
  auth.authenticateToken,
  ConsultationController.getByUser
);
routes.put(
  "/consultation/:consultation_id",
  ConsultationValidator.update,
  auth.authenticateToken,
  ConsultationController.update
);
routes.delete(
  "/consultation/:consultation_id",
  ConsultationValidator.delete,
  auth.authenticateToken,
